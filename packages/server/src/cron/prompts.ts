...
// Morning + evening insight JSON parsers live in insight-parsers.ts to keep
// prompts.ts focused on prompt building. Re-export their public API so
// existing import sites (executor, tests) keep working.
export {
  parseMorningInsight,
  parseEveningInsight,
  type ParsedMorningInsight,
  type ParsedEveningInsight,
} from "./insight-parsers.js"
