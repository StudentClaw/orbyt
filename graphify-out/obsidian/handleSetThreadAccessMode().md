---
source_file: "packages/server/src/ws/Router.ts"
type: "code"
...
# handleSetThreadAccessMode()

## Connections
- [[Router.ts]] - `contains` [EXTRACTED]
- [[decodeParams()]] - `calls` [EXTRACTED]
- [[encodeSuccess()]] - `calls` [EXTRACTED]
- [[handleOrchestrationMethod()]] - `calls` [EXTRACTED]
