...
## Who We Build For
- Students with multiple courses, deadlines, and competing priorities.
- Students who need structure but still want flexibility and control.
- Students who already use productivity tools and want one intelligent command center.

## Core Outcomes
- Better academic outcomes through clearer priorities and better execution.
- More consistent study cadence through realistic planning.
...
## Decision Filter
When evaluating new features, prefer work that:
1. Improves student outcomes directly.
2. Reduces planning and execution friction.
3. Strengthens memory-driven personalization.
4. Integrates into mission-control workflows without adding clutter.
