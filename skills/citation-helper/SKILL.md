...
3. If still ambiguous, optionally call `list_course_files` to look for a style guide the instructor shared (file names like "APA Template" or "Citation Guide").
4. If you still cannot determine the style, ask the student. Do not default silently.
